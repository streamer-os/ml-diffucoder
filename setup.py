...
#
# Adapted from huggingface/open-r1: https://github.com/huggingface/open-r1/blob/6a0cd5c8ad031fc75118a4ce7f42a4860c3d8dea/setup.py
...
_deps = [
    ...
    "trl @ git+https://github.com/huggingface/trl.git@1bca49515ecd5b85d16e68c42c76670e252e19f1",  # Fix DeepSpeed x vLLM conflict: https://github.com/huggingface/trl/pull/3351
    "vllm>=0.8.3",  # Explicitly specify vllm version
    "wandb>=0.19.1",
]
...
extras["vllm"] = deps_list("vllm")  # Add vllm as a separate extra
